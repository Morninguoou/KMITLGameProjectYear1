...
save_img = pygame.image.load('C:\\Users\\morningnoon\\programming pt\\Year 1\\ProjectGameDev\\ProjectGameDoc\\button/save_btn.png').convert_alpha() 
load_img = pygame.image.load('C:\\Users\\morningnoon\\programming pt\\Year 1\\ProjectGameDev\\ProjectGameDoc\\button/load_btn.png').convert_alpha()
...
def draw_bg():
	...
	for x in range(4):
		...
		screen.blit(mountain_img, ((x * width) - scroll * 0.6, SCREEN_HEIGHT - mountain_img.get_height() - 250))
		screen.blit(pine1_img, ((x * width) - scroll * 0.7, SCREEN_HEIGHT - pine1_img.get_height() - 75))
...
while run:
	...
	if save_button.draw(screen):
		#save level data
		with open(f'C:\\Users\\morningnoon\\programming pt\\Year 1\\ProjectGameDev\\level/level{level}_data.csv', 'w', newline='') as csvfile:
